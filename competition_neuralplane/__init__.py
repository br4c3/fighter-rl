"""GPU-batched reimplementation of the supplied competition F-16."""
...
__all__ = ["CompetitionF16FCSTorch", "FCSState", "CompetitionXMLAero",
           "airborne_properties", "CompetitionDynamics", "CompetitionF100", "EngineState",
