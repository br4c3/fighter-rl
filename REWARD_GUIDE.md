...
| 6 | `G0_in_wez_hold` | 320-860m | `damage_scale=12`, `dwell_scale=0.03`, `phi_scale=0.110` |
| 7 | `G1_wez_boundary_hold` | 260-940m | WEZ edge 유지, `phi_scale=0.090` |
| 8 | `G2_small_reacquire` | 450-1100m | 작은 재획득, `phi_scale=0.075` |
